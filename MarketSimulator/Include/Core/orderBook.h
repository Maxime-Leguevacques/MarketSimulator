...
private:
    ...
    std::map<unsigned int, std::queue<SMatchableOrder>, std::greater<>> bids_;    // bid is buy price
    std::map<unsigned int, std::queue<SMatchableOrder>> asks_;                    // ask is sell price
